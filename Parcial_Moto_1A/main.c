...
int main()
{
    ...
    HardcodearMoto(motos,TAMM,6,&nextId);//                        Hice estas funciones para agilizar el tema de las comprobaciones y no tener que hacerlo a mano, las dejo por si les sirve
    HardcodearTrabajos(trabajos,TAMTR,6,&nextIdTrabajo);
    do
    {
        system("cls");
        printf("*******ABM Motos*******\n");
        ...
        switch(opcion)
        {
            ...
            case 2:
                if(flag==1)
                {
                    ...
                    printf("\nDebe cargar al menos una moto para acceder a las modificaciones\n");
                }
            ...
            break;
             case 3:
                 if(flag==1)
                 {
                    ...
                    printf("\nDebe cargar al menos una moto para acceder a las bajas\n");
                }

                system("pause");
            break;
             case 4:
                      OrdenarMotos(motos,TAMM);
                      MostrarMotos(motos,TAMM,tipos,TAMT,colores,TAMC);

                     //printf("Hubo un problema con el ordenamiento\n");
            ...
            break;
             case 8:
                 if(flag==1)
                 {
                    ...
                    printf("\nDebe cargar al menos una moto para acceder a las a las altas de trabajo\n");
                }
                system("pause");
            break;
             case 9:
            ...
            break;
             case 10:
                    Informes(motos,TAMM,tipos,TAMT,colores,TAMC,trabajos,TAMTR,servicios,TAMS);
                system("pause");
                break;
             case 20:
